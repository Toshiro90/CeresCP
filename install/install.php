...
if (isset($POST_install)) {
	...
	$result = mysqli_query($cp_db, $query);
		...
		mysqli_query($cp_db, $query);
		
		//name change table
		$query = "DROP TABLE IF EXISTS `log_namechange`;";
		$result = mysqli_query($cp_db, $query);
		$query = "CREATE TABLE  `log_namechange` (
		...
		$result = mysqli_query($cp_db, $query);
		$query = "ALTER TABLE `char` ADD COLUMN `countnames` smallint(5) unsigned NOT NULL default '0';";
		$result = mysqli_query($cp_db, $query);
		
		//vote table
		$query = "CREATE TABLE `vote_point` (
		...
		//PVP ladder, should this be RO DB or CP DB?
		$query = "CREATE TABLE  `npc_pvpsys` 
			(`char_id` INT NOT NULL ,
			 `pvp_kills` INT NOT NULL ,
			 `pvp_deaths` INT NOT NULL ,
	...
	$buffer .= "\$CONFIG['email_registration']	=	'".$POST_feat_emailregistration."'; //On = 1, off = 2. This requires a player to confirm their email address \n";
	...
	$buffer .= "\$CONFIG['donations'] = '".$POST_feat_donation."'; //On or off enable=1, off=0\n";
	$buffer .= "\$CONFIG['vote4points'] = '".$POST_feat_v4p."'; //On or off enable=1, off=0\n";
	$buffer .= "\$CONFIG['changesex'] = '".$POST_feat_changesex."'; //On or off enable=1, off=0\n";
	$buffer .= "\$CONFIG['changename'] = '".$POST_feat_changename."'; //On or off enable=1, off=0\n";
	$buffer .= "\$CONFIG['pvpladder'] = '".$POST_feat_pvpladder."'; //On or off enable=1, off=0\n";	
	$buffer .= "\$CONFIG['prison_map']		=	'".$POST_feat_pm."';		// Name of the map that is used as your jail (mapname.gat)\n";
	$buffer .= "\n";
	$buffer .= "//Donation Configuration\n";
	$buffer .= "\$CONFIG['donates'] = '".$POST_feat_donates."'; //Enable=1 Disable=0\n";
	$buffer .= "\$CONFIG['domain'] = '".$POST_feat_baseurl."'; //the domain the websites on, i.e: http://testro.com\n";
	$buffer .= "\$CONFIG['paypal_email'] = '".$POST_feat_paypalemail."'; //your paypal email login, i.e.: test@gmail.com\n";
	$buffer .= "\n";
...
?>
							...
							<fieldset>
								...
								<table border="0" width="400">
									...
									<tr>
										...
										<td align="left"><select name="feat_vc"><option selected value="0">No</option><option value="1">Yes</option></select></td>
									</tr>
									<tr>
										<td align="left">Email Registration</td>
										<td align="left"><select name="feat_emailregistration"><option selected value="0">No</option><option value="1">Yes</option></select></td>
									</tr>
									<tr>
									...
									<tr>
										<td align="left">Admin Donation Manager</td>
										<td align="left"><select name="feat_donation"><option value="0">No</option><option selected value="1">Yes</option></select></td>
									</tr>
									<tr>
										<td align="left">Vote 4 Points</td>
										<td align="left"><select name="feat_v4p"><option value="0">No</option><option selected value="1">Yes</option></select></td>
										<td align="left">*See vote4points <strong>setup</strong>.txt in eAscripts folder</td>
									</tr>
									<tr>
										<td align="left">Change Sex</td>
										<td align="left"><select name="feat_changesex"><option value="0">No</option><option selected value="1">Yes</option></select></td>
									</tr>
									<tr>
										<td align="left">Change Name</td>
										<td align="left"><select name="feat_changename"><option value="0">No</option><option selected value="1">Yes</option></select></td>
									</tr>
									<tr>
										<td align="left">PVP Ladder</td>
										<td align="left"><select name="feat_pvpladder"><option value="0">No</option><option selected value="1">Yes</option></select></td>
										<td align="left">Requires eAthena script, found in eAscripts folder</td>
									</tr>
					...
					<tr>
						<td>
							<fieldset>
								<legend><b>Donation Configuration</b></legend>
								<table border="0" width="400">
									<tr>
										<td align="left">Paypal Email</td>
										<td align="left"><input type="text" name="feat_paypalemail" size="30" value="example@yahoo.com"></td>
									</tr>
									<tr>
										<td align="left">Site URL</td>
										<td align="left"><input type="text" name="feat_baseurl" size="30" value="http://YourRO-server.com"></td>
									</tr>
									<tr>
										<td align="left">Donations on</td>
										<td align="left"><select name="feat_donates"><option value="0">No</option><option selected value="1">Yes</option></select></td>
									</tr>
								</table>
							</fieldset>
						</td>
