...
if ($quantos)
	echo '<tr><td align="left"><b><span title="See who is online" class="link" onClick="LINK_ajax(\'whoisonline.php\',\'main_div\');">'.$lang['SERVERSTATUS_USERSONLINE'].'&nbsp;</span></b></td><td align="right">'.$quantos.'</td></tr>';
else
