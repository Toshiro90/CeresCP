...
if (isset($GET_id)) {
	...
	if ($line = $result->fetch_row()) {
		...
		';
		if (strcmp($line[2], 'M'))
			echo '<option value="M">'.$lang['SEX_MALE'].'<option selected="selected" value="F">'.$lang['SEX_FEMALE'];
		else
			echo '<option selected="selected" value="M">'.$lang['SEX_MALE'].'<option value="F">'.$lang['SEX_FEMALE'];
		echo '
						</select>
					</td>
				</tr><tr>
